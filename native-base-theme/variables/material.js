...
export default {
  ...
  // Segment
  segmentBackgroundColor: "#6198D8",
  segmentActiveBackgroundColor: "#fff",
  segmentTextColor: "#fff",
  segmentActiveTextColor: "#6198D8",
  segmentBorderColor: "#fff",
  segmentBorderColorMain: "#6198D8",
  ...
  // Title
  titleFontfamily: platform === "ios" ? "roboto" : "roboto-medium",
  titleFontSize: 19,
  subTitleFontSize: 14,
  subtitleColor: "#FFF",
